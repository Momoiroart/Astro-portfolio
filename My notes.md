...
03/23/2026 : Initialize astro porject
		to init project you have to have node.js in your machine firsthanded or download it before you start making your project. 
# **Command:**
- node -v : use to verify version of your version of node.js in your machine, also use as to confirm that you had the node.js itsellf because you can get it version.
